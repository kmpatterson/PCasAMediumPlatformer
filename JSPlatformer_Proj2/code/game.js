...
var actorChars = {
  ...
  "=": Lava, "|": Lava, "v": Lava, //Moving lava types
...
//Enemy initialization, size, and position
function Enemy(pos) {
	this.basePos = this.pos = pos.plus(new Vector (0, -2));
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  // Player loses
  if (type == "lava" && this.status == null || type == "enemy" && this.status == null) {
    this.status = "lost";
    this.finishDelay = 1;
  } else if (type == "coin") {
