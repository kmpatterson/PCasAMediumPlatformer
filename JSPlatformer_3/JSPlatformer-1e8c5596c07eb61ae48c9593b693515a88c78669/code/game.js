...
//New actor type: spike
function Spike(pos){
	this.pos = pos.plus(new Vector(0, -0.5));
	this.size = new Vector(0.8, 2.0);
...
//Act function for spike
var maxStep = 0.05;

var wobbleSpeed = 2, wobbleDist = 3;
...
Level.prototype.playerTouched = function(type, actor) {
  if (type == "coin") {
	...
	//If spike is touched by player, sent to beginning of level (e.g. they die)
	if (type == "spike") {
